...
CREATE TABLE public.ames (
    ...
    bsmtqual character varying,
    bsmtcond character varying,
    bsmtexposure character varying,
    bsmtfintype1 character varying,
    bsmtfinsf1 integer,
    bsmtfintype2 character varying,
    bsmtfinsf2 integer,
    bsmtunfsf integer,
    totalbsmtsf integer,
    ...
    fireplaces integer,
    fireplacequ character varying,
    garagetype character varying,
    garageyrblt integer,
    garagefinish character varying,
    garagecars integer,
    garagearea integer,
    garagequal character varying,
    garagecond character varying,
    ...
    screenporch integer,
    poolarea integer,
    poolqc character varying,
    fence character varying,
    miscfeature character varying,
    miscval integer,
    mosold integer,
    yrsold integer,
